...
parser.add_argument('--prefix', type=str, default='result', help='parent save path')
...
def main():
    ...
    model.derive_optimized_arch(derive_queue, arch_normal, arch_reduce, 10, logger, args.save, "derive",
                                normal_concat=genotype.normal_concat, reduce_concat=genotype.reduce_concat)
